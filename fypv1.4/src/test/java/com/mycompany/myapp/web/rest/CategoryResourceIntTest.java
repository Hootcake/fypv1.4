...
public class CategoryResourceIntTest {
    ...
    private static final Integer DEFAULT_WEIGHING = 1;
    private static final Integer UPDATED_WEIGHING = 2;
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getWeighing()).isEqualTo(DEFAULT_WEIGHING);
    ...
    @Test
    @Transactional
    public void checkWeighingIsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
        category.setWeighing(null);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].weighing").value(hasItem(DEFAULT_WEIGHING)));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.weighing").value(DEFAULT_WEIGHING));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getWeighing()).isEqualTo(UPDATED_WEIGHING);
