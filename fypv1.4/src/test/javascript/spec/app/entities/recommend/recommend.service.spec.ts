...
describe('Service Tests', () => {
    ...
    describe('Recommend Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RecommendService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/recommends';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Recommend', () => {

                let entity: Recommend;
                service.find(123).subscribe((_entity: Recommend) => {
                    entity = _entity;
                });
