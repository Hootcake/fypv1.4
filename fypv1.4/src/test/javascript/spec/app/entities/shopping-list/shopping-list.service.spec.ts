...
describe('Service Tests', () => {
    ...
    describe('Shopping_List Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(Shopping_ListService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/shopping-lists';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Shopping_List', () => {

                let entity: Shopping_List;
                service.find(123).subscribe((_entity: Shopping_List) => {
                    entity = _entity;
                });
