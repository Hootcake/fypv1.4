...
public class FoodPalApp {

    private static final Logger log = LoggerFactory.getLogger(FoodPalApp.class);

    private final Environment env;

    public FoodPalApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FoodPalApp.class);
