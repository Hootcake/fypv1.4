...
public class Category implements Serializable {
    ...
    public Category weighing(Integer weighing) {
    ...
    public Category inventories(Set<Inventory> inventories) {
        this.inventories = inventories;
        return this;
    }

    public Category addInventory(Inventory inventory) {
        this.inventories.add(inventory);
        inventory.setCategory(this);
        return this;
    }

    public Category removeInventory(Inventory inventory) {
